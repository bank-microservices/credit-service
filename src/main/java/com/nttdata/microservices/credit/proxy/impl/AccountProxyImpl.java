...
public class AccountProxyImpl implements AccountProxy {
  ...
  public Flux<AccountDto> findByAccountNumberAndClientDocument(String accountNumber, String documentNumber) {
    ...
    String errorMessage = String.format("There is Account not available with accountNumber: %s and documentNumber: %s", params.values().toArray());
  ...
  public Mono<AccountDto> findByAccountNumber(String accountNumber) {
    String errorMessage = String.format("There is Account not available with accountNumber: %s ", accountNumber);
    return this.webClient.get()
